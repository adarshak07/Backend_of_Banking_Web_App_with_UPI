...
public class GlobalExceptionHandler {
    ...
    @ResponseBody
    public ResponseEntity<ResponseModel> handleAccessDenied(AccessDeniedException ex) {
        return ResponseEntity
    ...
    @ResponseStatus(HttpStatus.CONFLICT)
    @ResponseBody
    public ResponseEntity<ResponseModel> handleInsufficientFunds(InsufficientFundsException ex) {
    ...
    @ResponseStatus(HttpStatus.CONFLICT)
    @ResponseBody
    public ResponseEntity<ResponseModel> handleInsufficientCoins(InsufficientCoinsException ex) {
        java.util.Map<String, Object> body = new java.util.HashMap<>();
        body.put("error", "INSUFFICIENT_COINS");
        body.put("available", ex.getAvailable());
        return ResponseEntity
                .status(HttpStatus.CONFLICT)
                .body(ResponseModel
    ...
    public ResponseEntity<ResponseModel> handleDataIntegrity(org.springframework.dao.DataIntegrityViolationException ex) {
        java.util.Map<String, Object> body = new java.util.HashMap<>();
